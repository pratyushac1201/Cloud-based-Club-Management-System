		...
		<div class="row">
			...
			<div class="col-lg-offset-2 col-lg-6">
				<form class="form-signin" method="post" action="">
					...
					<input type="text" name="name" placeholder="max 150 char" id="name" class="form-control" required><br>
					<label for="name">Notice Description</label>
					<textarea name="description" placeholder="Description max 250 char" id="email" class="form-control" required></textarea><br>
